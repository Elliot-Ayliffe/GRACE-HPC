# Command-line Interface (CLI) Usage Example 

This file shows an example of how to use GRACE-HPC through the CLI.

## Generate and Edit the Configuration File (hpc_config.yaml)
